...
const RecentTransaction: FC<TransactionProps> = ({ transaction }) => {
  return (
    <div className={`pt-8 pb-8
      ...
      <p className="px-6 mb-2 w-fit text-body-3xs text-black opacity-80 uppercase">ONGOING TRANSFER</p>
      <div className='px-6'>
...
const Transaction: FC<TransactionProps> = ({ transaction }) => {
  return (
    <div className='px-6 hover:bg-primary hover:bg-opacity-[5%] group'>
